...
namespace identity_2auth_mvc.Data.Migrations
{
    ...
    [Migration("20210714070523_add_fields_to_Course")]
    partial class add_fields_to_Course
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("identity_2auth_mvc.Models.Klas.CourseUser", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("identity_2auth_mvc.Models.Klas.CourseUser", b =>
                {
                    ...
                    b.HasOne("identity_2auth_mvc.Models.AppUser", "AppUser")
                        .WithMany("CourseUsers")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
